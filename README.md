[![GoDoc](https://godoc.org/github.com/llgoer/go-xml?status.svg)](https://godoc.org/github.com/llgoer/go-xml) [![Build Status](https://travis-ci.org/droyo/go-xml.svg?branch=master)](https://travis-ci.org/droyo/go-xml)
...
```
go get github.com/llgoer/go-xml/...
```
